...
# Safety imports (in case creep_rupture_sindy doesn't import these)
import pandas as pd
...
def example_basic_workflow():
    ...
    # ✅ DEBUG: show columns before and after standardization
    print("RAW COLUMNS:", list(df.columns))

    df = standardize_columns(df)

    print("AFTER STANDARDIZE:", list(df.columns))
